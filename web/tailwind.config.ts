...
export default {
  ...
  theme: {
    extend: {
      // ── Paleta alinhada à app Mobile (fonte da verdade de UI).
      // Valores espelhados de mobile/flutter/lib/core/constants/app_colors.dart.
      // Excepção deliberada: `warning` mantém o castanho acessível do Web
      // (#B45309) em vez do âmbar #F4B400 da Mobile, pois é usado como cor de
      // texto (`text-warning`) e o âmbar sobre fundo claro falha o contraste.
      colors: {
        primary: {
          DEFAULT: '#8B1A1A',
          dark: '#690008',
