    ...
    return ScreenFrame(
      ...
      children: [
        ...
        if (user.role == UserRole.superAdmin) ...[
          AdminActionCard(icon: Icons.priority_high, title: 'Cadeia de Super Admins', subtitle: 'Hierarquia e sucessão por grau.', onTap: () => Navigator.pushNamed(context, AppRoutes.superAdminChain)),
          const SizedBox(height: 10),
        ],
